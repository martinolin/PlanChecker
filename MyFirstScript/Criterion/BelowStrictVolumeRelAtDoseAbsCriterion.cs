...
{
    [Serializable]
    public class BelowStrictVolumeRelAtDoseAbsCriterion : Criterion
    {
        public BelowStrictVolumeRelAtDoseAbsCriterion()
        { }
        public BelowStrictVolumeRelAtDoseAbsCriterion(BelowStrictVolumeRelAtDoseAbsCriterion c) : base(c) { }

        public BelowStrictVolumeRelAtDoseAbsCriterion(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
        ...
        { return new BelowStrictVolumeRelAtDoseAbsCriterion(this); }
