...
{
    [Serializable]
    public class BelowVolumeAbsAtDoseRelCriterion : Criterion
    {
        public BelowVolumeAbsAtDoseRelCriterion()
        { }
        public BelowVolumeAbsAtDoseRelCriterion(BelowVolumeAbsAtDoseRelCriterion c) : base(c) { }
        public BelowVolumeAbsAtDoseRelCriterion(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
        ...
        { return new BelowVolumeAbsAtDoseRelCriterion(this); }
