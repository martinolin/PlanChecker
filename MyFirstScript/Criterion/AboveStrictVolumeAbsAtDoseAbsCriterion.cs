...
{
    [Serializable]
    public class AboveStrictVolumeAbsAtDoseAbsCriterion : Criterion
    {
        public AboveStrictVolumeAbsAtDoseAbsCriterion()
        {
        }
        public AboveStrictVolumeAbsAtDoseAbsCriterion(AboveStrictVolumeAbsAtDoseAbsCriterion c) : base(c) { }

        public AboveStrictVolumeAbsAtDoseAbsCriterion(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
        ...
        { return new AboveStrictVolumeAbsAtDoseAbsCriterion(this); }
        public override bool Analyze(VMS.TPS.Common.Model.API.PlanSetup planSetup, VMS.TPS.Common.Model.API.Structure eclipseStructure)
        {
