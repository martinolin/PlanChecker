...
{
    [Serializable]
    public class AboveMedianDoseAbs : Criterion
    {
        public AboveMedianDoseAbs()
        {
        }
        public AboveMedianDoseAbs(AboveMedianDoseAbs c) : base(c) { }

        public AboveMedianDoseAbs(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
        ...
        { return new AboveMedianDoseAbs(this); }
