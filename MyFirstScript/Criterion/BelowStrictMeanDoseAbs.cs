...
{
    [Serializable]
    public class BelowStrictMeanDoseAbs : Criterion
    {
        public BelowStrictMeanDoseAbs()
        {
        }
        public BelowStrictMeanDoseAbs(BelowStrictMeanDoseAbs c) : base(c) { }

        public BelowStrictMeanDoseAbs(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
        ...
        { return new BelowStrictMeanDoseAbs(this); }
