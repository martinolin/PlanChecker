...
{
    [Serializable]
    public class AboveMinDoseRel : Criterion
    {
        public AboveMinDoseRel()
        {
        }
        public AboveMinDoseRel(AboveMinDoseRel c) : base(c) { }

        public AboveMinDoseRel(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            partPlan = inPartPlan;
            volume = inVolume;
        ...
        { return new AboveMinDoseRel(this); }
