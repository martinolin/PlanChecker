...
{
    [Serializable]
    public class AboveDoseAbsAtVolumeAbsCriterion : Criterion
    {
        public AboveDoseAbsAtVolumeAbsCriterion()
        {
        }
        public AboveDoseAbsAtVolumeAbsCriterion(AboveDoseAbsAtVolumeAbsCriterion c) : base(c) { }
        public AboveDoseAbsAtVolumeAbsCriterion(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
        ...
        { return new AboveDoseAbsAtVolumeAbsCriterion(this); }
