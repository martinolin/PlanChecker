...
{
    [Serializable]
    public class AboveStrictMedianDoseRel : Criterion
    {
        public AboveStrictMedianDoseRel()
        {
        }
        public AboveStrictMedianDoseRel(AboveStrictMedianDoseRel c) : base(c) { }

        public AboveStrictMedianDoseRel(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
        ...
        { return new AboveStrictMedianDoseRel(this); }
