...
{
    [Serializable]
    public class AboveStrictMaxDoseRel : Criterion
    {
        public AboveStrictMaxDoseRel()
        {
        }
        public AboveStrictMaxDoseRel(AboveStrictMaxDoseRel c) : base(c) { }

        public AboveStrictMaxDoseRel(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
        ...
        { return new AboveStrictMaxDoseRel(this); }
