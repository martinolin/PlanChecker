...
{  [Serializable] 
    public class AboveStrictMeanDoseAbs:Criterion
    {
        public AboveStrictMeanDoseAbs()
        {
        }
        public AboveStrictMeanDoseAbs(AboveStrictMeanDoseAbs c) : base(c) { }

        public AboveStrictMeanDoseAbs(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
        ...
        {
            return new AboveStrictMeanDoseAbs(this);
        }
