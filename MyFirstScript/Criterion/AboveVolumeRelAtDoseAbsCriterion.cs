...
{
    [Serializable]
    public class AboveVolumeRelAtDoseAbsCriterion : Criterion
    {
        public AboveVolumeRelAtDoseAbsCriterion()
        { }
        public AboveVolumeRelAtDoseAbsCriterion(AboveVolumeRelAtDoseAbsCriterion c) : base(c) { }

        public AboveVolumeRelAtDoseAbsCriterion(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
        ...
        { return new AboveVolumeRelAtDoseAbsCriterion(this); }
