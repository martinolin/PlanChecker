...
{ [Serializable] 
    public class AboveMeanDoseRel:Criterion
    {
       public AboveMeanDoseRel()
        {
        }
       public AboveMeanDoseRel(AboveMeanDoseRel c) : base(c) { }

       public AboveMeanDoseRel(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
       ...
       { return new AboveMeanDoseRel(this); }
