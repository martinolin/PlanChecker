...
{
    [Serializable]
    public class BelowMeanDoseRel : Criterion
    {
        public BelowMeanDoseRel()
        {
        }
        public BelowMeanDoseRel(BelowMeanDoseRel c) : base(c) { }

        public BelowMeanDoseRel(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
        ...
        { return new BelowMeanDoseRel(this); }
