...
{
    [Serializable]
    public class AboveStrictMaxDoseAbs : Criterion
    {
        public AboveStrictMaxDoseAbs()
        {
        }
        public AboveStrictMaxDoseAbs(AboveStrictMaxDoseAbs c) : base(c) { }

        public AboveStrictMaxDoseAbs(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
        ...
        { return new AboveStrictMaxDoseAbs(this); }
