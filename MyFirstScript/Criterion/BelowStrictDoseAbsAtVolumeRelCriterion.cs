...
{
    [Serializable]
    public class BelowStrictDoseAbsAtVolumeRelCriterion : Criterion
    {
        public BelowStrictDoseAbsAtVolumeRelCriterion()
        {
        }
        public BelowStrictDoseAbsAtVolumeRelCriterion(BelowStrictDoseAbsAtVolumeRelCriterion c) : base(c) { }

        public BelowStrictDoseAbsAtVolumeRelCriterion(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            PartPlan = inPartPlan;
            dose = inDose;
            volume = inVolume;
        ...
        { return new BelowStrictDoseAbsAtVolumeRelCriterion(this); }
