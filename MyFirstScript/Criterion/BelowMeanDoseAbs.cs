...
{
    [Serializable]
    public class BelowMeanDoseAbs : Criterion
    {
        public BelowMeanDoseAbs()
        {
        }
        public BelowMeanDoseAbs(BelowMeanDoseAbs c) : base(c) { }

        public BelowMeanDoseAbs(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
        ...
        { return new BelowMeanDoseAbs(this); }
