...
{
    [Serializable]
    public class BelowStrictMinDoseAbs : Criterion
    {
        public BelowStrictMinDoseAbs()
        {
        }
        public BelowStrictMinDoseAbs(BelowStrictMinDoseAbs c) : base(c) { }

        public BelowStrictMinDoseAbs(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
        ...
        { return new BelowStrictMinDoseAbs(this); }
