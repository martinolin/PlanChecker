...
{
    [Serializable]
    public class BelowVolumeAbsAtDoseAbsCriterion : Criterion
    {
        public BelowVolumeAbsAtDoseAbsCriterion()
        {
        }
        public BelowVolumeAbsAtDoseAbsCriterion(BelowVolumeAbsAtDoseAbsCriterion c) : base(c) { }

        public BelowVolumeAbsAtDoseAbsCriterion(double inDose, double inVolume, int inPriority, int inPartPlan)
        {
            dose = inDose;
            volume = inVolume;
            priotity = inPriority;
        ...
        { return new BelowVolumeAbsAtDoseAbsCriterion(this); }
